        ...
        <form className="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search">
          <div className="input-group">
            <input
              ...
              inputMode="tel"
            />
            <button className="btn btn-primary py-0" type="button" onClick={() => makeCall()}>
          ...
          <li className="nav-item dropdown no-arrow">
            <div className="nav-item dropdown no-arrow">
              <a
                ...
                href="#"
              >
                <span className="d-none d-lg-inline me-2 text-gray-600 small">Carlos Washington</span>
                <img className="border rounded-circle img-profile" src={`/src/assets/img/carlos.png`} alt="Profile" />
              </a>
